...
// 몇 분 마다 이 스크립트를 실행할 것인가 설정
var farming_interval = 30;
var farming_interval_ms = farming_interval * 60 * 1000;
...
function send_farm_list(){
    ...
    console.log("Next attack after %d minutes...", farming_interval);
    // 사용자가 설정한 시간 후에 make_farm_list 함수 실행 (무한 반복)
    setTimeout(make_farm_list, farming_interval_ms);
}
